...
[![IMAGE ALT TEXT HERE](https://img.youtube.com/vi/vbqfb-dhZRY/0.jpg)](https://youtu.be/vbqfb-dhZRY?si=iUzshkBW2ADkZbKx) 
...
### Features  
1. **Video Conversion**: Users can easily import their favorite dance videos, and the system will automatically convert them into playable 3D dance animations using MotionBERT machine learning technology.
2. **Motion Recognition**: Real-time motion recognition using a smartphone, paired with MR glasses for action comparison and scoring.
3. **Mixed Reality Experience**: Provides an immersive dance learning and gaming experience through Meta Quest 3 glasses.
4. **Personalization**: Users can adjust dance animations to achieve a more personalized gaming experience.
...
### Future Prospects  
1. **Add Level and Store System**: Accumulate experience points based on gameplay performance to unlock more content.
2. **Expand Exercise Types**: Add other exercise types or dance genres, such as yoga, fitness, hip-hop, etc.
3. **Cloud Conversion System**: Move the video conversion function to the cloud for convenient access anytime, anywhere.
